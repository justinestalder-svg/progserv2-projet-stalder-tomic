...
- **Compatibilité** : pourcentage de compatibilité avec un ami et titres aimés en commun.
...
Claude (Anthropic) a été utilisé pour comparer nos idées de projet et structurer ce cahier des charges. Le contenu a été relu et validé par l'équipe.
